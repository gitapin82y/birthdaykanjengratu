...
content.addEventListener("click", function () {
  ...
  if (scene == 0) {
    ...
    text.innerHTML = "Sama kaya hidup aku pas ada kamu tauuu hehehehe";
  } else if (scene == 4) {
    ...
    text.innerHTML =
      "abstrak tapi cantik banget, jadi aku mau tunjukin ke kamu";
  } else if (scene == 7) {
    ...
    text.innerHTML = "aku mau nunjukin sesuatu";
  } else if (scene == 20) {
    ...
    text.innerHTML =
      "aku mau bilang mulai sekarang, kamu gaboleh insecure sama diri kamu sendiri ya, itu gabaik tau buat kamu kedepannya";
  } else if (scene == 41) {
    text.innerHTML =
      "kamu sampai ke titik ini aja aku udah bangga banget sama kamu";
  } else if (scene == 42) {
    ...
    window.location.href = "https://wipinn.wixsite.com/for-aiko";
  } else if (scene >= 46) {
    text.innerHTML = "";
